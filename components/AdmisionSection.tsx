...
const AdmisionSection: React.FC = () => {
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-border bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900">
                  <th className="px-6 py-5 text-left text-sm font-bold text-foreground uppercase tracking-wider">Program de studiu</th>
                  <th className="px-6 py-5 text-right text-sm font-bold text-foreground uppercase tracking-wider">Medie admitere</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-gray-900">
                {admissionData.map((item, index) => (
                  <tr key={index} className="border-b border-border last:border-0 transition-all duration-200 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <td className="px-6 py-6 text-foreground font-semibold text-lg transition-colors duration-200 group-hover:text-primary">{item.program}</td>
                    <td className="px-6 py-6 text-right">
                      <span className={`inline-flex items-center justify-center min-w-[90px] px-5 py-3 rounded-lg font-bold text-xl transition-all duration-200 ${getScoreColor(item.average)} ${getScoreBackground(item.average)} group-hover:scale-105 border border-blue-200 dark:border-blue-800`}>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="flex flex-col items-center md:items-start gap-4 p-6 rounded-xl bg-gray-50 dark:bg-gray-800 transition-all duration-200 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-200 border-2 border-transparent group">
                  ...
                  <div className="text-center md:text-left w-full">
                    ...
                    <a href="tel:0233215853" className="text-foreground font-medium hover:text-primary transition-colors text-lg">0233.215.853</a>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center md:items-start gap-4 p-6 rounded-xl bg-gray-50 dark:bg-gray-800 transition-all duration-200 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-200 border-2 border-transparent group">
                  ...
                  <div className="text-center md:text-left w-full">
                    ...
                    <a href="mailto:cnch@isjneamt.ro" className="text-foreground font-medium hover:text-primary transition-colors text-lg">cnch@isjneamt.ro</a>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center md:items-start gap-4 p-6 rounded-xl bg-gray-50 dark:bg-gray-800 transition-all duration-200 hover:bg-blue-50 dark:hover:bg-blue-950 hover:border-blue-200 border-2 border-transparent group md:col-span-2 lg:col-span-1">
                  ...
                  <div className="text-center md:text-left w-full">
                    ...
                    <a href="https://www.facebook.com/colegiulhogas/" target="_blank" rel="noopener noreferrer" className="text-foreground font-medium hover:text-primary transition-colors text-lg break-words">facebook.com/colegiulhogas</a>
                  </div>
                </div>
              </div>
            </div>
